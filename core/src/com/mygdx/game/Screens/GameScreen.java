...
//            if(pl.getNickName().equals(mainController.credentialsScreen.nickName)){
//                thisPlayer = pl;
//                break;
//            }
        }
...
//behemoth ... nu dedschideti
    void resizeOpponents(){
        ...
        Queue<Player> opponents  =  players;
        //opponents.remove(mainController.getToken().getNickname());

        System.out.println( " resizeOppnets PlayerList" + players);

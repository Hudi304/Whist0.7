package com.mygdx.networking.networkController;
...
public interface NetworkController {
     ...
     * ex: when you try to connect to server, when the connection is establish... the parameter isConnected will be true;
     * @param isConnected
     */
